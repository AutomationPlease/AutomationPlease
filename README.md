...
- **Languages & Tools**: Python, SQL, PySide6/PyQt6, pandas, VBA, SAP scripting.
- **Specialties**: Desktop GUI development, ETL pipelines, data visualization, KPI dashboards, and supply chain systems.
- **Notable Project**: Designed and developed **Supply Chain Dashboard**, a full-featured PySide6 supply chain analytics desktop application featuring real-time dashboards, interactive customer mapping, and configurable data integration.
